...
def test_buy_cert():
    ...
    driver.find_element(By.XPATH,
                        "//div[@class='tariff tariff-container-common']//a[contains(@data-tplan,'Удобный. Спецрежим')]").click()
    ...
    if auto == 'y':
        ...
        driver.find_element(By.XPATH,
                            "//div[@name='inputFns']").click()
        driver.find_element(By.XPATH, "//div[@name='inputFns']").clear()
        driver.find_element(By.XPATH, "//div[@name='inputFns']").send_keys('7731')

        driver.implicitly_wait(15)

        driver.find_element(By.XPATH,
                            " //a[contains( @title, '7731')]").click()
...
def test_cancel():
    driver.implicitly_wait(15)
    driver.find_element(By.XPATH, "//a[contains(@href,'CancelModal')]")
    ...
    directory_folder = r"C:\Users\User\Desktop\for_zaglushki\last_request_id\otchetnost"
    ...
    driver.find_element(By.XPATH, "//a[contains(@href,'CancelModal')]").click()
