...
if len(os.listdir(r'C:\Users\User\Desktop\for_zaglushki\last_request_id\add_serv\cryptopro5_add_serv_3')) == 0:
...
while num != 0:
    ...
    num_files = sum(
        os.path.isfile(os.path.join(r'C:\Users\User\Desktop\for_zaglushki\last_request_id\add_serv\cryptopro5_add_serv_3', f)) for f in
        os.listdir(r'C:\Users\User\Desktop\for_zaglushki\last_request_id\add_serv\cryptopro5_add_serv_3'))
    ...
    list_of_files = glob.glob(
        r"C:\Users\User\Desktop\for_zaglushki\last_request_id\add_serv\cryptopro5_add_serv_3\*")
